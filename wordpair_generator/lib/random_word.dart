...
class RandomWords extends StatefulWidget{
  ...
  class RandomWordsState extends State<RandomWords> {
    ...
    final _savedWordPairs = Set<WordPair>();//A set is a collection of object whereneach object is unique.
...
//----Widget that builds the list
  ...
  Widget _buildRow(WordPair word) {
      ...
      return ListTile(
        ...
        trailing: Icon(alreadySaved? Icons.favorite:Icons.favorite_border,//add icon if pair is already saved
              color: alreadySaved ? Colors.red: null),//add color if pair is already saved using ternary operation on the color widget
      );
  }
}